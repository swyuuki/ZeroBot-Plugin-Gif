...
func (cc Paths) Diu() string {
	...
	diu := []*image.NRGBA{
		...
		img.ImDc(cc.Sc+`diu/3.png`, 0, 0).Over(tou, 123, 123, 19, 129).Im,
		img.ImDc(cc.Sc+`diu/4.png`, 0, 0).Over(tou, 185, 185, -50, 200).Over(tou, 33, 33, 289, 70).Im,
		img.ImDc(cc.Sc+`diu/5.png`, 0, 0).Over(tou, 32, 32, 280, 73).Im,
		img.ImDc(cc.Sc+`diu/6.png`, 0, 0).Over(tou, 35, 35, 259, 31).Im,
		img.ImDc(cc.Sc+`diu/7.png`, 0, 0).Over(tou, 175, 175, -50, 220).Im,
	}
